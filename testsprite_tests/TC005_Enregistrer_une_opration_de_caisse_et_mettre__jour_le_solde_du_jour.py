...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the HTTPS URL for the application (https://localhost/cabinetsavwa/public)
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Opération enregistrée avec succès')]").nth(0).is_visible(), "The daily cash balance should update and the new operation should appear in the operations list after saving."
