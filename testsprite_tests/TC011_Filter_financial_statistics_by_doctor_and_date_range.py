...
async def run_test():
    ...
    try:
        ...
        # -> Retry loading the application using HTTPS (navigate to https://localhost/cabinetsavwa/public).
        await page.goto("https://localhost/cabinetsavwa/public")
        
        # -> Fill the Identifiant with 'moctar', fill the Mot de passe with '1234', then click 'Se connecter' to submit the login form.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Statistiques financières')]").nth(0).is_visible(), "The statistics summary should be visible after applying the doctor and date filters."
