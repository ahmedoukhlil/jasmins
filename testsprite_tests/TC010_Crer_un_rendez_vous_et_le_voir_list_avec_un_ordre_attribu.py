...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the HTTPS site URL so the application can load.
        await page.goto("https://localhost/cabinetsavwa/public")
        
        # -> Fill the login form (identifiant and mot de passe) and submit it by clicking 'Se connecter'.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Rendez-vous N° 1')]").nth(0).is_visible(), "The rendez-vous list should show the newly created rendez-vous with its assigned order number after creation"
