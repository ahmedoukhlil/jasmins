...
async def run_test():
    ...
    try:
        ...
        # -> Load the application over HTTPS (navigate to https://localhost/cabinetsavwa/public).
        await page.goto("https://localhost/cabinetsavwa/public")
        
        # -> Fill Identifiant with 'moctar' and Mot de passe with '1234', then submit to sign in.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Reçu PDF')]").nth(0).is_visible(), "The PDF receipt view should be opened and show the created invoice for the consultation."]}endees**
