...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the application's HTTPS login page so I can locate the login form and attempt a login with an incorrect password.
        await page.goto("https://localhost/cabinetsavwa/public/login")
        
        # -> Fill the login and password fields with the invalid credentials and submit the form, then observe the page for an invalid-credentials error message.
