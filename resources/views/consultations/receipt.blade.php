...
<head>
    ...
    <style>
        ...
        /* Bouton WhatsApp */
        .whatsapp-btn { background: #25D366; color: #fff; border: 1px solid #25D366; display: flex; align-items: center; gap: 6px; white-space: nowrap; }
        .whatsapp-btn:hover { background: #128C7E; }
        .whatsapp-logo { width: 15px; height: 15px; fill: currentColor; }
        .print-btn { background: #1d4ed8; color: #fff; border-color: #1d4ed8; }
